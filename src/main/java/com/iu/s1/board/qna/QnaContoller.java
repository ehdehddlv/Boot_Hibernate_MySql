...
public class QnaContoller {
	...
	@GetMapping("qnaList")
	public ModelAndView boardList(@PageableDefault(size = 10, page = 0, direction = Direction.DESC, sort = {"num"}) Pageable pageable, String search, String kind) throws Exception{
		ModelAndView mv = new ModelAndView();
